...
public class GuessingBirthdays {
	...
	public static void main(String[] args) {
		//Guessing the birth day from an array of numbers; prompt the user to enter 0 for no or 1 for yes
	    ...
	    for (int i = 0; i < 5; i++) {
	      ...
	      if (answer == 1)
	    	  //If the user enters yes, for each day, the number of sets at the first row, at the first index is added to its value
	    	  day += dates[i][0][0];
	    }
